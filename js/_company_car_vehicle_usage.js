$(document).ready(function(){
	utils.setPageHeader("page_header","Vehicle Usage","<li><a href='#'><i class='fa fa-dashboard'></i> Home</a></li><li class='active'>Company Car Vehicle Usage</li>");
	var start_date = "";
	var end_date = "";
/*
	...
	$("#btn_generate").click(function(){
		...
		if( (start_date != "" && end_date != "") || vehicle_id != "" || driver_no != ""){
			$.ajax({
				...
				url:"ajax/get_vehicle_usage.php",
	...
	$("#btn_export_excel").click(function(){
        ...
        $.ajax({
        	...
        	url:"ajax/ccvu_export_excel.php",
        	success:function(response){
