$(document).ready(function() {
    ...
    utils.setPageHeader("page_header","All Trip Tickets","<li><a href='#'><i class='fa fa-dashboard'></i> Home</a></li><li class='active'>All Trip Tickets</li>");
...
/*    table.columns().every( function () {
    ...
    var dpicker = $('#txt_request_date').daterangepicker({
        "showDropdowns": true,
    ...
    // 
    $('#txt_request_date').on('apply.daterangepicker', function(ev, picker) {
