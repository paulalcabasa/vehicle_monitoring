...
$(document).ready(function(){
	...
	$("#txt_tl_vehicle_id").focus();
	utils.setPageHeader("page_header","New Expats Log","<li><a href='#'><i class='fa fa-dashboard'></i> Home</a></li><li class='active'>New Errand Log</li>");
	...
	$("#btn_save").click(function(){
		...
		if(errorCtr == 0){
			...
			$.ajax({
				...
				url:"ajax/add_expats_time_log.php",
				success:function(response){
					location.reload();
					//isSubmit = true;
