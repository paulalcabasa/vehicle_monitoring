...
$(document).ready(function(){
	...
	$("#txt_tl_vehicle_id").focus();
	utils.setPageHeader("page_header","Update Expats Log","<li><a href='#'><i class='fa fa-dashboard'></i> Home</a></li><li class='active'>Update Expats Log</li>");
			...
			$.ajax({
				...
				success:function(response){
					...
					$.ajax({
						...
						url:"ajax/add_expats_passenger.php",
						success:function(response){
							//alert(response);
						}
					});
	...
	$("#btn_save").click(function(){
		...
		if(errorCtr == 0){
			...
			$.ajax({
				...
				url:"ajax/update_expats_log.php",
				success:function(response){
					//alert(response)
					location.reload();
					//isSubmit = true;
