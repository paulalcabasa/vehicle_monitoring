$(document).ready(function(){
	utils.setPageHeader("page_header","Monitoring","<li><a href='#'><i class='fa fa-dashboard'></i> Home</a></li><li class='active'>E-Pass Monitoring</li>");
	var start_date = "";
	var end_date = "";
	var epass_no = "";
	...
	var table = $("#tbl_epass_monitoring").DataTable();
	...
	$("#btn_generate").click(function(){
		...
		if(start_date != "" && end_date != ""){
			...
			$.ajax({
				...
				url:"ajax/get_epass_monitoring_report.php",
				success:function(response){
					if(response != ""){
						table.destroy();
						$("#tbl_epass_monitoring tbody").html(response);
						table = $("#tbl_epass_monitoring").DataTable();
						table.draw();
						$("#btn_export_pdf").removeAttr("disabled");
					}
					else {
						$("#btn_export_pdf").attr("disabled","disabled");
						$("#tbl_epass_monitoring tbody").html("<tr><td colspan='13' align='center'>No records found.</td></tr>");
					}
