  ...
  <!-- quick email widget -->
    <div class="box box-danger">
        ...
        <div class="box-header">
            ...
            <h3 class="box-title">Vehicle Usage - Car Plan</h3>
        </div>

        <div class="box-body">

         <div class="row"> <!-- first row -->
                <form action="pages/print_carplan_vehicle_usage.php" id="frm_print" class="form-horizontal" method="POST" target="_blank">
                    <div class="col-md-6">
