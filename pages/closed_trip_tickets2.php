<?php
    ...
    if(isset($_POST['trip_ticket_no'])){
        $trip_ticket_no = $_POST['trip_ticket_no'];
    ...
    <div class="box-header">
      ...
      <?php
       if($user_access->user_type == "Administrator" || $user_access->user_type == "SuperUser") {
        if($user_data->employee_id == "184" || $user_data->employee_id == "483" || $user_data->employee_id == "1"){
      ?>
    ...
    <div class="box-body">
        ...
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" value="" id="txt_request_date" class="form-control"/>
                </div>
            </div>
        </form>
        </div>
