...
foreach($vehicle_list as $unit){
    ...
    $values .= '<tr nobr="true" style="font-size:9px;">';
        $values .= '<td style="width:5%;">' . $index . '</td>';
        $values .= '<td style="width:15%;">' . Format::formatVehicleId($unit->id) . '</td>';
        $values .= '<td style="width:15%;">' . $unit->assignee. '</td>';
        $values .= '<td style="width:15%;">' . $unit->cs_no. '</td>';
        $values .= '<td style="width:15%;">' . $unit->plate_no. '</td>';
        $values .= '<td style="width:20%;">' . $unit->model . '</td>';
        $values .= '<td style="width:15%;">' . $unit->classification. '</td>';
    $values .= '</tr>';
    $index++;
}
...
$table .= '<thead>
                <tr>
                    <th style="text-align:center;background-color:#dfe2ea;width:5%;">No</th>
                    <th style="text-align:center;background-color:#dfe2ea;width:15%;">Vehicle ID</th>
                    <th style="text-align:center;background-color:#dfe2ea;width:15%;">Assignee</th>
                    ...
                    <th style="text-align:center;background-color:#dfe2ea;width:15%;">Classification</th>
                </tr>
           </thead>
           <tbody>';
$table .= $values;
