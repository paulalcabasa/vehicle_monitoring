...
if(isset($post->txt_report_date)){
	...
	$vehicle_usage_report = $vehicle->getVehicleUsageReportCarplan(Format::format_date_only($start_date)." 00:00:00",Format::format_date_only($end_date)." 23:59:59",$vehicle_id,$driver_no);
...
$page_header = '<h1 style="font-family:Arial, Sans, Tahoma, Verdana;font-size:13pt;text-align:center;">Weekly, Monthly and Annual Vehichle Monitoring for Car Plans</h1>';
