...
if(isset($_POST['start_date']) && isset($_POST['end_date'])){
	...
	foreach($managers_attendance as $attendance){
		...
		$timesheet_summary .= "<tr>";
			$timesheet_summary .= "<td>" . $attendance->employee_no . "</td>";
			$timesheet_summary .= "<td>" . Format::makeUpperCase($attendance->employee_name) . "</td>";
...
$title = '<div style="width:100%;background-color:#FFF;color:#000;text-align:center;font-size:13px;font-weight:bold;">
...
$summary_content = '<table style="font-size:9px;" cellpadding="4" border="1">
						...
						<tr style="background-color:#dfe2ea;">	
							<th style="font-weight:bold;width:10%;">Employee No</th>
							<th style="font-weight:bold;width:30%;">Name</th>
							<th style="font-weight:bold;width:30%;">Date</th>
							<th style="font-weight:bold;width:15%;">In</th>
							<th style="font-weight:bold;width:15%;">Out</th>
						</tr>
