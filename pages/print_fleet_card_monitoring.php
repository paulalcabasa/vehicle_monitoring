...
if(isset($post->txt_report_date)){
	...
	$fleet_card_monitoring_report = $fleet_card->getFleetCardMonitoringReport(Format::format_date_only($start_date)." 00:00:00",Format::format_date_only($end_date)." 23:59:59");
	foreach($fleet_card_monitoring_report as $report) {
		$report = (object)$report;
		$table_body .= '<tr>
							<td>'.$report->fleet_card_id.'</td>
