<?php
    ...
    $active_trip_tickets = $trip_ticket->get_active_trip_tickets($from_date,$to_date,$tt_no);
...
<section class="col-md-12">
  ...
  <div class="box box-danger">
    ...
    <div class="box-body">
        <div class="col-md-8">
            <form class="form" method="POST" id="frm_tt" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?p=vt";?>">
        ...
        <table class="table table-bordered table-hover table-condensed" cellspacing="0" style="font-size:85%;"  id="tbl_trip_ticket" width="100%">
            <thead>
                <tr>
                    <th class="no-sort"></th>
            ...
            <tbody>
            <?php
            foreach($active_trip_tickets as $row){
                $row = (object)$row;
            ?>
                <tr>
