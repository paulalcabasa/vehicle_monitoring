<?php
    ...
    $errand = new Errand();
    $dec_id = $encryption->decrypt($get->d);
    $log_details = $errand->getTimeLogDetails($dec_id);
    $log_type_list = $trip_ticket->getLogType();
    $formatted_vehicle_id = Format::formatVehicleId($log_details->vehicle_id);
    $passengers_list = $errand->getPassengersByTimeLogId($dec_id);
?>
                ...
                <div class="col-md-6">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="hidden" class="form-control" id="txt_log_id" value="<?php echo $log_details->id;?>"/>
                               <input type="text" class="form-control" id="txt_tl_vehicle_id" tabindex="1"  style="text-transform:uppercase;" value="<?php echo $formatted_vehicle_id;?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="text" class="form-control" style="text-transform:uppercase;" id="txt_tl_driver_id" value="<?php echo $log_details->driver_no;?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="text" class="form-control" id="txt_tl_driver_name" value="<?php echo $log_details->driver_name;?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                foreach($log_type_list as $log_type){
                                    ...
                                    $is_checked = $log_type->id == $log_details->log_type_id ? "checked" : "";
                                ?>
                                <div class="radio">
                                    <label>
                                    <input type="radio" name="rdo_log_type" class="rdo_log_type" value="<?php echo $log_type->id;?>" <?php echo $is_checked;?>/>
                ...
                <div class="col-md-6">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="txt_km_reading"  value="<?php echo $log_details->km_reading;?>"/>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                ...
                                <?php
                                    ...
                                    foreach($list_of_fuel_status AS $fuel_status){
                                        ...
                                        $is_selected = $fuel_status->id == $log_details->fuel_status_id ? "selected" : "";
                                ?>
                                    <option value="<?php echo $fuel_status->id;?>" <?php echo $is_selected;?>><?php echo $fuel_status->status;?></option>
                                <?php
                                    }
                                ?>
                                </select>
                       ...
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control noresize" placeholder="Purpose" id="txt_remarks"><?php echo $log_details->remarks;?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                ?>
                                    <li class="list-group-item" data-id="<?php echo $passenger->id;?>"><?php echo $passenger->passenger_name;?></li>
                                <?php
                                    }
                                ?>
                                 </ul>
